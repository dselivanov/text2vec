...
#    # Worth to set n_chunks to 1 because we already splitted input
#    lapply(itoken, n_chunks = 1, preprocess_function = tolower,
#           tokenizer = word_tokenizer, progessbar = FALSE)
#
...
#  #         tokenizer = word_tokenizer, n_chunks = 1, progessbar = FALSE)
