...
Lets demonstrate package core functionality by applying it to a real problem - sentiment analysis.
...
Before doing analysis it usually can be useful to *transform* DTM. For example lengths of the documents in collection can significantly vary. At this case it can be useful to apply normalization.
...
After that we can do our analysis and probably have more chance for success.
