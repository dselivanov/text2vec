...
**text2vec** provides `movie_review` dataset. It consists of 25000 movie review, each of which marked ad positive or negative. For faster vignette building time in this vignette we will use sample of 5000 reviews.
```{r, loading-data, eval=TRUE}
library(text2vec)
data("movie_review")
set.seed(42L)
N <- 5000
movie_review <- movie_review[sample(nrow(movie_review), N), ]
```
