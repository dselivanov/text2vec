...
Now we have `71290` terms in vocalulary and ready to construct term-co-occurence matrix (TCM).
...
# get term-co-occurence matrix from the instance of the C++ corpus class
tcm <- get_tcm(corpus)
```
...
Finally let's fit our model (it can take several of minutes to fit!):
