...
Alternatively, if your data fits in RAM, you can create a list of tokens once and then reuse it in further steps. Each element of the list should represent a document, and each element should be a character vector of tokens.
...
We trained this model faster with a slightly larger AUC.
