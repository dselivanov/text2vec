...
names(reviews) <- movie_review$id

it <- itoken(reviews, preprocess_function = tolower, 
...
As you can see, it has `r dim(dtm)[[1]]` rows, equal to the number of documents, and `r dim(dtm)[[2]]` columns, equal to the number of unique terms.
